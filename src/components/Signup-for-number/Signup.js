        ...
        <div className='mb-20'>
          ...
          <div className='text-center'>
            <p className="text-sm text-[#C5C5C6]">
              By providing your phone number, you’re agree to the term of <span className='text-blueButtonColor'>privacy</span> and <span className='text-blueButtonColor'>policy.</span>
            </p> 
          </div> 
          <div className="mt-6">
         <Link to='/signup-code'>

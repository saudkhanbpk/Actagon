...
const AmountToRequest = () => {
  ...
  console.log("state in request:", state.friend)
  return (
    <div className="bg-white p-4 md:p-8 lg:p-12 xl:p-16">
      ...
      <div className="flex flex-col items-center pt-6">
        <img src={state.friend.profile_img} alt="User Avatar" className="w-16  md:w-32 md:h-32 xl:w-48 xl:h-48 rounded-full" />
        ...
        <h2 className="text-[#817F80] font-normal text-sm">{state.friend.username}</h2>

        <div className="pt-3">
          <input type='text' placeholder='amount' className="border border-[#C6C6C8] rounded-lg py-2 px-12 w-full"
          />
